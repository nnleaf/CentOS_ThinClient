...
sh -c 'echo "=====================================================" >> /tmp/install.log'
sh -c 'echo "=             Version 1.1 [Office Build]            =" >> /tmp/install.log'
sh -c 'echo "=                Released 2022.03.21                =" >> /tmp/install.log'
...
sed -i "/Allow root to run any commands anywhere/ a ${username1} ALL=NOPASSWD: /usr/local/bin/setdns.sh,/usr/local/bin/office_instructions.sh" /etc/sudoers
